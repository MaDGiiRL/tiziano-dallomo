...
const stats = [
  { value: "1964", label: "anno di nascita", icon: Calendar },
  { value: "30+", label: "anni di esperienza", icon: TrendingUp },
  { value: "globale", label: "attività internazionale", icon: Globe },
];
      ...
      <div className="grid min-h-[76vh] lg:grid-cols-2">
        ...
        <div className="flex flex-col justify-center px-7 py-10 md:px-12 xl:px-16">
          ...
          <div className="flex items-center gap-2">
            <SlideIcon className="h-4 w-4 text-sky-300" />
          ...
          <p className="mt-6 max-w-2xl text-base leading-7 text-slate-300">
            ...
            compresa una Licenza in Teologia biblica. Molte persone si rivolgono
            a lui per le questioni più delicate.
          </p>
          ...
          <div className="mt-10 flex flex-wrap gap-3">
            <a
              href="#contatti"
              className="flex items-center gap-2 rounded-2xl border border-sky-400/30 bg-sky-400/10 px-5 py-3 text-sm font-medium text-sky-100 transition hover:bg-sky-400/18"
            >
            ...
            <a
              href="#kindle"
              className="flex items-center gap-2 rounded-2xl border border-slate-600/70 bg-slate-800/70 px-5 py-3 text-sm font-medium text-slate-100 transition hover:bg-slate-800"
            >
